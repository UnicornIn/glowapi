...
export const APP_MODULES = {
  ...
  SUPER_FICHAS_CONFIG: "SUPER_FICHAS_CONFIG",
  ...
  SEDE_FICHAS_CONFIG: "SEDE_FICHAS_CONFIG",
...
const SUPER_ADMIN_MODULES: AppModule[] = [
  ...
  APP_MODULES.SUPER_FICHAS_CONFIG,
];
...
const ADMIN_SEDE_MODULES: AppModule[] = [
  ...
  APP_MODULES.SEDE_FICHAS_CONFIG,
];
...
export const ROUTE_ACCESS_MAP: Record<string, AppModule> = {
  ...
  "/superadmin/fichas": APP_MODULES.SUPER_FICHAS_CONFIG,
  ...
  "/sede/fichas": APP_MODULES.SEDE_FICHAS_CONFIG,
